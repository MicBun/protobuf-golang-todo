module github.com/MicBun/protobuf-golang-todo

go 1.20

require (
	github.com/darkweak/souin/plugins/echo v0.0.0-20230527101359-03e157594281
...
require (
	...
	github.com/darkweak/souin v1.6.38 // indirect
